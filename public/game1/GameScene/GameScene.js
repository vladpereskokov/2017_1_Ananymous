...
export default class GameScene {
  ...
  _appendFloor() {
    ...
    sceneManager.add(new threeFactory.Mesh(
      new threeFactory.CubeGeometry(2500, 10, 2500),
      new threeFactory.MeshLambertMaterial({color: 0x1c1c1c,/*map: t.ImageUtils.loadTexture('images/floor-1.jpg')*/})
    ));
  }
