...
// Setup
    function init() {
      ...
      // Set up camera
      cam = threeFactory.perspectiveCamera(60, ASPECT, 1, 10000);
      cam.position.y = UNITSIZE * .2;
      scene.add(cam);

      // Camera moves with mouse, flies around with WASD/arrow keys
      controls = new FirstPersonControl(cam, checkWallCollision.bind(this), document, createBullet.bind(this));
...
// Set up the objects in the world
    function setupScene() {
      ...
      var floor = new t.Mesh(
        ...
        new t.MeshLambertMaterial({color: 0x1c1c1c,/*map: t.ImageUtils.loadTexture('images/floor-1.jpg')*/})
      );
      scene.add(floor);
